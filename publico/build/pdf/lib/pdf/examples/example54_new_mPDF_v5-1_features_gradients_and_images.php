...
filter: progid:DXImageTransform.Microsoft.gradient(startColorstr=\'#cccccc\', endColorstr=\'#b1b1b1\'); /* for IE */<br />
background: -webkit-gradient(linear, left top, left bottom, from(#cccccc), to(#b1b1b1)); /* for webkit browsers */<br />
background: -moz-linear-gradient(top,  #cccccc,  #b1b1b1); /* for firefox 3.6+ */<br />
</p>
