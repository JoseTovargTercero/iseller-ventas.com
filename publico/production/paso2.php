 ...
 <form action='' method='post'>
                                            ...
                                            <div class='col-lg-12'>
                                              <h1 style="text-align:center; font-size:158px"> 
                                                <img src="images/Sin-t%C3%ADtulo-2.png" class="mail" alt="mail">
                                               ...
                                               <br>
                                                 ...
                                                 <br>
                                   <br>
                                           <p class="favorite ">Para recibir los reportes en su correo, usted deberá conceder permisos para app de terceros en los siguientes enlaces. Recuerde estar previamente logueado con la misma cuenta que registro en el paso anterior.</p>
                                           
                                           <a href="https://myaccount.google.com/lesssecureapps?utm_source=google-account&utm_medium=web&pli=1&rapt=AEjHL4PMIgGjhab5IzMfrnpX25JfS-bZ5HJKFN80qafh9Ygx4F3GVExQrwCHc5w9ncu5JoOd5nMRKpSahUoQkPzn4Y7ZI-skEA" target="_blank" class='btn btn-info '>Enlace 1</a>
                                           <a href="https://accounts.google.com/b/0/DisplayUnlockCaptcha" target="_blank" class='btn btn-info '>Enlace 2</a>
                                           
                                            </div>
                                  
                                            <a href="configuracion.php?accion=correo" class='btn btn-success right'>Siguiente</a>
                                        </form>
                <?php
            ...
            if(ValidaCorreo($correoRecibido)){
                if($corteRE == "on"){$corteRE = 1;}
                if($cierreRE == "on"){$cierreRE = 1;}
                $insertar = "INSERT INTO mail (correo, cierre, cortes) VALUES ('$correoRecibido','$cierreRE','$corteRE')";
                $resultado2 = mysqli_query( $conexion, $insertar );
                define( 'PAGINA_RETORNO', 'paso2.php' );
