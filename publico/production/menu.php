    ...
    <div class='container body'>
        <div class='main_container'>
                ...
                <ul class="navbar-items flexbox-col">
                    <li class="navbar-logo d-flex justify-content-between" style="    padding-left: 10px;">
                        <a class="navbar-item-inner flexbox">
                            <img src='images/logo1-inv-compact.png' style='max-width:40px; opacity: 0.8'> <span>
                        </a>
                        <a class="navbar-item-inner flexbox" id="menu_button">
                        </a>
                    </li>
            ...
            <div class="right_col">
                ...
                <div class="x_panel mb-3" style="min-height: 60vh">
