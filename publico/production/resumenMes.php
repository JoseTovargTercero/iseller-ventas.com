...
if ($_SESSION['nivel'] == 1 || $_SESSION['nivel'] == 2) {
    ...
    $queryaaaaaaa = "SELECT * FROM orden WHERE fecha='$mesConsulta' AND tipoPago='8' AND status='1' OR fecha='$mesConsulta' AND tipoPago='8' AND status='4'";
    ...
    $query1111111 = "SELECT * FROM orden WHERE fecha='$mesConsulta' AND tipoPago='1' AND status='1' OR fecha='$mesConsulta' AND tipoPago='1' AND status='4'";
    ...
    $totalVentas222222 = 0;
    $query222222 = "SELECT * FROM orden WHERE fecha='$mesConsulta' AND tipoPago='2' AND status='1' OR fecha='$mesConsulta' AND tipoPago='2' AND status='4'";
    ...
    $query33333333 = "SELECT * FROM orden WHERE fecha='$mesConsulta' AND tipoPago='3' AND status='1' OR fecha='$mesConsulta' AND tipoPago='3' AND status='4'";
    ...
    $query4444444 = "SELECT * FROM orden WHERE fecha='$mesConsulta' AND tipoPago='4' AND status='1' OR fecha='$mesConsulta' AND tipoPago='4' AND status='4'";
    ...
    // BS EFECTIVO
    $totalVentas55555 = 0;
    $query55555 = "SELECT * FROM orden WHERE fecha='$mesConsulta' AND tipoPago='5' AND status='1' OR fecha='$mesConsulta' AND tipoPago='5' AND status='4'";
    ...
    // DOLARES
    $totalVentas666666 = 0;
    $query666666 = "SELECT * FROM orden WHERE fecha='$mesConsulta' AND tipoPago='6' AND status='1' OR fecha='$mesConsulta' AND tipoPago='6' AND status='4'";
    ...
    $query7777777 = "SELECT * FROM orden WHERE fecha='$mesConsulta' AND tipoPago='7' AND status='1' OR fecha='$mesConsulta' AND tipoPago='7' AND status='4'";
    ...
    switch ($mesConsulta) {
        case (date('Y') . '-' . '01'):
            $textoMes1 = "<span style='color: #1ABB9C;'>ENERO</span>";
            $textoMes = 'ENERO';
            break;

        case (date('Y') . '-' . '02'):
            $textoMes2 = "<span style='color: #1ABB9C;'>FEBRERO</span>";
            $textoMes = 'FEBRERO';
            break;

        case (date('Y') . '-' . '03'):
            $textoMes3 = "<span style='color: #1ABB9C;'>MARZO</span>";
            $textoMes = 'MARZO';
            break;

        case (date('Y') . '-' . '04'):
            $textoMes4 = "<span style='color: #1ABB9C;'>ABRIL</span>";
            $textoMes = 'ABRIL';
            break;

        case (date('Y') . '-' . '05'):
            $textoMes5 = "<span style='color: #1ABB9C;'>MAYO</span>";
            $textoMes = 'MAYO';
            break;

        case (date('Y') . '-' . '06'):
            $textoMes6 = "<span style='color: #1ABB9C;'>JUNIO</span>";
            $textoMes = 'JUNIO';
            break;

        case (date('Y') . '-' . '07'):
            $textoMes7 = "<span style='color: #1ABB9C;'>JULIO</span>";
            $textoMes = 'JULIO';
            break;

        case (date('Y') . '-' . '08'):
            $textoMes8 = "<span style='color: #1ABB9C;'>AGOSTO</span>";
            $textoMes = 'AGOSTO';
            break;

        case (date('Y') . '-' . '09'):
            $textoMes9 = "<span style='color: #1ABB9C;'>SEPTIEMBRE</span>";
            $textoMes = 'SEPTIEMBRE';
            break;

        case (date('Y') . '-' . '10'):
            $textoMes10 = "<span style='color: #1ABB9C;'>OCTUBRE</span>";
            $textoMes = 'OCTUBRE';
            break;

        case (date('Y') . '-' . '11'):
            $textoMes11 = "<span style='color: #1ABB9C;'>NOVIEMBRE</span>";
            $textoMes = 'NOVIEMBRE';
            break;

        case (date('Y') . '-' . '12'):
            $textoMes12 = "<span style='color: #1ABB9C;'>DICIEMBRE</span>";
            $textoMes = 'DICIEMBRE';
            break;
    }
    ...
    function total($tipo)
    {
        ...
        $query5 = "SELECT * FROM orden WHERE fecha='$mesConsulta' AND status='$tipo'";
    ...
    $query5 = "SELECT * FROM orden WHERE fecha='$mesConsulta' AND status='1' OR fecha='$mesConsulta' AND status='4'";
    $buscarAlumnos25 = $conexion->query($query5);
    if ($buscarAlumnos25->num_rows > 0) {
        while ($filaAlumnos25 = $buscarAlumnos25->fetch_assoc()) {
            $VentasMesDolar = $filaAlumnos25['total_price'];
    ...
    function returnGanancias($tipo)
    {
        ...
        $sqlGanancias = "SELECT * FROM orden WHERE fecha='$mesConsulta' AND status='$tipo'";
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ///////////////////GANANCIAS DEL mes//////////////////////////
    $query2222234 = "SELECT * FROM orden WHERE fecha='$mesConsulta' AND status='1' AND tipoPago='5' OR fecha='$mesConsulta' AND status='4' AND tipoPago='5'";
    ...
    $query0000034 = "SELECT * FROM orden WHERE fecha='$mesConsulta' AND status='1' AND tipoPago='8' OR fecha='$mesConsulta' AND status='4' AND tipoPago='8'";
...
fecha='$mesConsulta' AND status='1' AND tipoPago='1' OR
fecha='$mesConsulta' AND status='4' AND tipoPago='1' OR
fecha='$mesConsulta' AND status='1' AND tipoPago='2' OR 
fecha='$mesConsulta' AND status='4' AND tipoPago='2' OR 
fecha='$mesConsulta' AND status='1' AND tipoPago='3' OR 
fecha='$mesConsulta' AND status='4' AND tipoPago='3' OR 
fecha='$mesConsulta' AND status='1' AND tipoPago='4' OR 
fecha='$mesConsulta' AND status='4' AND tipoPago='4' OR
fecha='$mesConsulta' AND status='1' AND tipoPago='7' OR 
fecha='$mesConsulta' AND status='4' AND tipoPago='7'
";
...
fecha='$mesConsulta' AND status='1' AND tipoPago='6' OR
fecha='$mesConsulta' AND status='4' AND tipoPago='6'";
            ...
            <div class='main_container'>
                ...
                <div class='right_col' role='main'>
                    ...
                    <div class=''>
                        ...
                        <div class="col-lg-12">
                            <h4>Ventas</h4>
                            <p style="margin-top: -10px;">Ventas del mes</p>
                        </div>
                        ...
                        <div class='row  fadeInUp animated' style='display: block;'>
                            ...
                            <div class='col-lg-9'>
                                <div class='x_panel'>
                                    <div class='x_title'>
                                        <h2>Detalles <small><?php echo $textoMes; ?> DEL <?php echo date('Y'); ?></small> </h2>
                                                ...
                                                <div class='card-box table-responsive'>
                                                    ...
                                                    <table id='datatable-responsive' class='table table-striped table-bordered' style='width:100%'>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            $query77 = "SELECT * FROM orden WHERE status='1' AND fecha='$mesConsulta' OR status='4'  AND fecha='$mesConsulta' ORDER BY id DESC LIMIT 150";
                                ...
                                <div class='x_panel tile'>
                                    <div class='x_title'>
                                        ...
                                        <ul class='nav navbar-right panel_toolbox'>
                                            ...
                                            <li class="dropdown">
                                                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">SELECCIONAR MES</a>
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                    <a class='dropdown-item' href='?mesConsulta=01'>&nbsp;<?php echo $textoMes1; ?></a>
                                                    <a class='dropdown-item' href='?mesConsulta=02'>&nbsp;<?php echo $textoMes2; ?></a>
                                                    <a class='dropdown-item' href='?mesConsulta=03'>&nbsp;<?php echo $textoMes3; ?></a>
                                                    <a class='dropdown-item' href='?mesConsulta=04'>&nbsp;<?php echo $textoMes4; ?></a>
                                                    <a class='dropdown-item' href='?mesConsulta=05'>&nbsp;<?php echo $textoMes5; ?></a>
                                                    <a class='dropdown-item' href='?mesConsulta=06'>&nbsp;<?php echo $textoMes6; ?></a>
                                                    <a class='dropdown-item' href='?mesConsulta=07'>&nbsp;<?php echo $textoMes7; ?></a>
                                                    <a class='dropdown-item' href='?mesConsulta=08'>&nbsp;<?php echo $textoMes8; ?></a>
                                                    <a class='dropdown-item' href='?mesConsulta=09'>&nbsp;<?php echo $textoMes9; ?></a>
                                                    <a class='dropdown-item' href='?mesConsulta=10'>&nbsp;<?php echo $textoMes10; ?></a>
                                                    <a class='dropdown-item' href='?mesConsulta=11'>&nbsp;<?php echo $textoMes11; ?></a>
                                                    <a class='dropdown-item' href='?mesConsulta=12'>&nbsp;<?php echo $textoMes12; ?></a>
                                                </div>
