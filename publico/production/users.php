...
?>
	...
	<script type="text/javascript">
		...
		function confirmar(){
			var confirm= alertify.confirm('Eliminar Usuario','Se borrara un usuario del sistema, desea continuar?',null,null).set('labels', {ok:'Confirmar', cancel:'Cancelar'}); 
                                ...
                                <div class='x_content altoScroll'>
                                    <form class='' action='../../configurar/agguser.php' method='post' novalidate>
                                        ...
                                        <div class='field item form-group'>
                                            ...
                                            <div class='col-md-9 col-sm-9'>
                                                <input class='form-control' type='password' name='password' data-validate-length='6,7,8,9,10,11,12' required='required' /></div>
                                        </div>
                                        <div class='field item form-group'>
