                                 ...
                                 <table class="table-personalizada">
                                     ...
                                     <tbody>
                                         <tr>
                                             ...
                                             <th class="mio3"><?php if($Inicio == 1 || $Clientes == 1){ echo "<a href='?desactivarG=Inicio'><img src='images/ON.PNG' alt='on' height='20px'</a>"; }else{ echo "<a href='?activarG=Inicio'><img src='images/OFF.PNG' alt='off' height='20px'<a/>"; } ?></th>
                                         </tr> 
                                        <tr>
                                             <th class="mio">Inicio</th>
                                             <th class="mio"><?php if($Inicio == 1){ echo "<a href='?desactivar=Inicio'><img src='images/ON.PNG' alt='on' height='20px'</a>"; }else{ echo "<a href='?activar=Inicio'><img src='images/OFF.PNG' alt='off' height='20px'<a/>"; } ?></th>  
                                              </tr>
                                               
                                             <tr>
                                             <th class="mio">Clientes</th>
                                             <th class="mio"><?php if($Clientes == 1){ echo "<a href='?desactivar=Clientes'><img src='images/ON.PNG' alt='on' height='20px'</a>"; }else{ echo "<a href='?activar=Clientes'><img src='images/OFF.PNG' alt='off' height='20px'<a/>"; } ?></th>
                                         </tr>
                                             ...
                                             <th class="mio3"><?php if($Ventas == 1 || $VentasSemana == 1 || $VentasMes == 1){ echo "<a href='?desactivarG=Ventas'><img src='images/ON.PNG' alt='on' height='20px'</a>"; }else{ echo "<a href='?activarG=Ventas'><img src='images/OFF.PNG' alt='off' height='20px'<a/>"; } ?></th>
                                         </tr> 
                                            ...
                                            <tr>        
                                             ...
                                             <th class="mio"><?php if($Ventas == 1){ echo "<a href='?desactivar=Ventas'><img src='images/ON.PNG' alt='on' height='20px'</a>"; }else{ echo "<a href='?activar=Ventas'><img src='images/OFF.PNG' alt='off' height='20px'<a/>"; } ?></th>
                                         </tr>                                           
                                            <tr>        
                                             <th class="mio">Ventas de la semana</th>
                                             <th class="mio"><?php if($VentasSemana == 1){ echo "<a href='?desactivar=VentasSemana'><img src='images/ON.PNG' alt='on' height='20px'</a>"; }else{ echo "<a href='?activar=VentasSemana'><img src='images/OFF.PNG' alt='off' height='20px'<a/>"; } ?></th>
                                         </tr> 
                                                                                     
                                            <tr>        
                                             <th class="mio">Ventas del mes</th>
                                             <th class="mio"><?php if($VentasMes == 1){ echo "<a href='?desactivar=VentasMes'><img src='images/ON.PNG' alt='on' height='20px'</a>"; }else{ echo "<a href='?activar=VentasMes'><img src='images/OFF.PNG' alt='off' height='20px'<a/>"; } ?></th>
                                         </tr>
                                            ...
                                            <tr>
                                             ...
                                             <th class="mio3"><?php if($Nueva_Compra == 1 || $Nuevo_Producto == 1){ echo "<a href='?desactivarG=Nuevo_Producto'><img src='images/ON.PNG' alt='on' height='20px'</a>"; }else{ echo "<a href='?activarG=Nuevo_Producto'><img src='images/OFF.PNG' alt='off' height='20px'<a/>"; } ?></th>
                                         </tr>
                                            
                                            <tr>
                                             <th class="mio">Nueva Compra</th>
                                             <th class="mio"><?php if($Nueva_Compra == 1){ echo "<a href='?desactivar=Nueva_Compra'><img src='images/ON.PNG' alt='on' height='20px'</a>"; }else{ echo "<a href='?activar=Nueva_Compra'><img src='images/OFF.PNG' alt='off' height='20px'<a/>"; } ?></th>
                                         </tr>
                                            
                                              <tr>
                                             <th class="mio">Nuevo Producto</th>
                                             <th class="mio"><?php if($Nuevo_Producto == 1){ echo "<a href='?desactivar=Nuevo_Producto'><img src='images/ON.PNG' alt='on' height='20px'</a>"; }else{ echo "<a href='?activar=Nuevo_Producto'><img src='images/OFF.PNG' alt='off' height='20px'<a/>"; } ?></th>
                                         </tr>
                                            <tr>
                                             <th class="mio3">Control de Stock</th>
                                             <th class="mio3"><?php if($Creditos == 1 || $Dejado_Ganar == 1 || $Listado_Productos == 1){ echo "<a href='?desactivarG=Control_Stock'><img src='images/ON.PNG' alt='on' height='20px'</a>"; }else{ echo "<a href='?activarG=Control_Stock'><img src='images/OFF.PNG' alt='off' height='20px'<a/>"; } ?></th>
                                         </tr>
                                            
                                            
                                            <tr>
                                             <th class="mio">Creditos</th>
                                             <th class="mio"><?php if($Creditos == 1){ echo "<a href='?desactivar=Creditos'><img src='images/ON.PNG' alt='on' height='20px'</a>"; }else{ echo "<a href='?activar=Creditos'><img src='images/OFF.PNG' alt='off' height='20px'<a/>"; } ?></th>
                                         </tr><tr>
                                             <th class="mio">Dejado de Ganar</th>
                                             <th class="mio"><?php if($Dejado_Ganar == 1){ echo "<a href='?desactivar=Dejado_Ganar'><img src='images/ON.PNG' alt='on' height='20px'</a>"; }else{ echo "<a href='?activar=Dejado_Ganar'><img src='images/OFF.PNG' alt='off' height='20px'<a/>"; } ?></th>
                                         </tr><tr>
                                             <th class="mio">Listado De Productos</th>
                                             <th class="mio"><?php if($Listado_Productos == 1){ echo "<a href='?desactivar=Listado_Productos'><img src='images/ON.PNG' alt='on' height='20px'</a>"; }else{ echo "<a href='?activar=Listado_Productos'><img src='images/OFF.PNG' alt='off' height='20px'<a/>"; } ?></th>
                                         </tr>
                                      
                                         <tr>
                                             <th class="mio3">Vender</th>
                                             <th class="mio3"><?php if($Vender == 1){ echo "<a href='?desactivar=Vender'><img src='images/ON.PNG' alt='on' height='20px'</a>"; }else{ echo "<a href='?activar=Vender'><img src='images/OFF.PNG' alt='off' height='20px'<a/>"; } ?></th>
                                         </tr><tr>
                                             <th class="mio3">Consultas</th>
                                             <th class="mio3"><?php if($Consultas == 1){ echo "<a href='?desactivar=Consultas'><img src='images/ON.PNG' alt='on' height='20px'</a>"; }else{ echo "<a href='?activar=Consultas'><img src='images/OFF.PNG' alt='off' height='20px'<a/>"; } ?></th>
                                         </tr>
                                     </tbody>
                                 </table>
                                </div>
