...
if ( $buscarAlumnos2->num_rows > 0 ) {
    while( $filaAlumnos2 = $buscarAlumnos2->fetch_assoc() ) {
        $peso_bolivar = $filaAlumnos2['peso_bolivar'];
    }  
    }  
    $peso_bolivar += 1; 
    

$stmt_o = $conexion->prepare("UPDATE cambio SET pesoDolar='$dolarPeso', peso_bolivar='$peso_bolivar', DolarBolivar='$pesoBolivar', bolivarPesoVenta='$pesoBolivarPublicacion' WHERE id='1'");
$stmt_o->execute();
$stmt_o -> close();
