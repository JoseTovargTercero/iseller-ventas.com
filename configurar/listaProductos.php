...
if (isset($_POST['codigoEditar'])){
    ...
    $stmt = $conexion->prepare( "UPDATE productos SET nombre='$nombre', precio_compra='$precio_compra', cantidad_unidades='$cantidad_unidades', porcentaje='$porcentaje' WHERE codigo='$codigo'" );
    $stmt->execute();
$stmt->close();
