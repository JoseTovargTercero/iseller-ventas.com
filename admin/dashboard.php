...
function cargarDotEnv($ruta) {
    ...
    foreach ($lineas as $linea) {
        ...
        $nombre = trim($nombre); $valor = trim($valor);
...
<head>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .orb-2 { width: 400px; height: 400px; background: var(--accent-2); bottom: -150px; right: -150px; }
        ...
        .sidebar-logo-text .brand { font-size: 15px; font-weight: 700; }
        .sidebar-logo-text .tag   { font-size: 10px; color: var(--text-2); text-transform: uppercase; letter-spacing: 1.5px; }
        ...
        .nav-item:hover { background: var(--bg-card-h); color: var(--text-1); }
        ...
        .user-info .role { font-size: 10px; color: var(--text-2); }
        ...
        .header-left p  { font-size: 12px; color: var(--text-2); margin-top: 1px; }
        ...
        .btn-refresh:hover { background: var(--bg-card-h); color: var(--text-1); border-color: var(--border-light); }
        ...
        .kpi-card:nth-child(1) { --kpi-color: linear-gradient(90deg, #6366f1, #8b5cf6); animation-delay: 0.05s; }
        .kpi-card:nth-child(2) { --kpi-color: linear-gradient(90deg, #06b6d4, #6366f1); animation-delay: 0.10s; }
        .kpi-card:nth-child(3) { --kpi-color: linear-gradient(90deg, #22c55e, #06b6d4); animation-delay: 0.15s; }

        .kpi-label { font-size: 11px; font-weight: 600; text-transform: uppercase; letter-spacing: 1.2px; color: var(--text-2); margin-bottom: 12px; }
        .kpi-value { font-size: 36px; font-weight: 800; letter-spacing: -1.5px; color: var(--text-1); margin-bottom: 4px; }
        ...
        .cell-id  { color: var(--text-3); font-size: 11px; font-weight: 600; }
        ...
        /* ── Venta info cell ── */
        .venta-info { display: flex; flex-direction: column; gap: 2px; }
        .venta-id   { font-size: 10px; color: var(--text-3); }
        .venta-total{ font-size: 13px; font-weight: 700; color: var(--green); }
        .venta-date { font-size: 10px; color: var(--text-2); }
